    ...
    while(nextTurn.size()>1) {
        ...
        if (nextCell > boardsize) nextTurn.offer (player);
            ...
            if(nextPosition[0] ==boardSize){
	            ...
	            playersCurrentPosition.put(player.getPlayerName(),newPosition[0]);
	            System.out.println(playerr.getPlayerName() + " is at position " +nextPosition[0]);
